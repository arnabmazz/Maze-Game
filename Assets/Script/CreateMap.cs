...
public class CreateMap : MonoBehaviour 
{
    ...
    public void CreateGround()
    {
        for (int i = 0; i < X; i++)
        {
            for (int j = 0; j < Y; j++)
            {
                Floor item = Instantiate(groundPrefab, transform).GetComponent<Floor>();
    ...
    public void CreateWall1()
    {
        for (int i = 0; i < X; i++)
        {
            for (int j = 0; j < Y + 1; j++)
            {
                ...
                Wall item = Instantiate(wallPrefab, transform).GetComponent<Wall>();
    ...
    public void CreateWall2()
    {
        for (int i = 0; i < X + 1; i++)
        {
            for (int j = 0; j < Y; j++)
            {
                Wall item = Instantiate(wallPrefab1 ,transform).GetComponent<Wall>();
